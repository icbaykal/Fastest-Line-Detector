...
int CreateStringList(FILE *(*p_InFile), int *NoOfCols,
	...
	ORTPoint *(*StringList));
int LinkSegments(int StringListSize, Liste StringListID, ORTPoint *StringList,
	int *SegmentListSize, Liste *SegmentListID, ORTSegment *(*SegmentList));
int StringToSegments(int MaxJumpPixels, int StringListSize, Liste StringListID,
	ORTPoint *StringList, int *SegmentListSize, Liste *SegmentListID, ORTSegment *(*SegmentList));
int DrawBezierLine();
